...
public class FixComponentType {
    ...
    public static Glob create(String name) {
        return TYPE.instantiate().set(FixComponentType.name, name);
    }

    static {
        GlobTypeBuilder builder = GlobTypeBuilderFactory.create("FixComponentType");
